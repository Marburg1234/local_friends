...
# ========================================================================================
  ...
  def self.looks(search, word)
    @user = User.joins(:country).joins(:region).where.not(is_active: false).where.not(email: "guest@example.com").where("family_name LIKE ? OR first_name LIKE ? OR countries.name LIKE ? OR regions.name LIKE ?", "%#{word}%", "%#{word}%", "%#{word}%", "%#{word}%").distinct
  end
# ========================================================================================
